 ...
 */
export type RatioName = 'minorSecond' | 'majorSecond' | 'minorThird' | 'majorThird' | 'perfectFourth' | 'augmentedFourth' | 'perfectFifth' | 'minorSixth' | 'majorSixth' | 'golden' | 'harmonic' | 'photographic';
/**
 ...
 */
export type MathematicalScale = FibonacciScale | 'geometric' | 'modular' | 'linear' | 'exponential' | 'logarithmic';
/**
 ...
 */
export type ColorHarmony = 'triadic' | 'analogous' | 'complementary' | 'split-complementary' | 'tetradic' | 'square';
/**
 ...
 */
export type CSSCalculationType = 'spacing-system' | 'color-palette' | 'typography-scale' | 'grid-layout' | 'z-index-layer' | 'wcag-contrast' | 'aspect-ratio-grid' | 'responsive-breakpoints' | 'full-design-system';
/**
 ...
 */
export declare class CSSEngineError extends Error {
    code: string;
 ...
 */
export declare class CSSValidationError extends CSSEngineError {
    constructor(message: string, details?: unknown);
}
/**
 * Compute timeout error
 */
export declare class CSSComputeTimeoutError extends CSSEngineError {
    constructor(timeoutMs: number);
}
/**
 * WCAG contrast failure error
 */
export declare class WCAGContrastError extends CSSEngineError {
    foreground: string;
    background: string;
    ratio: number;
    required: number;
    constructor(message: string, foreground: string, background: string, ratio: number, required: number);
}
/**
 * Export all types as namespace for convenience
 */
export declare namespace CSSEngine {
    type Ratio = RatioName;
    type Scale = FibonacciScale;
    type Harmony = ColorHarmony;
    type WCAG = WCAGLevel;
    type CalculationType = CSSCalculationType;
    type Request = CSSCalculationRequest;
    type Result = CSSCalculationResult;
    type Package = DesignPackage;
    type Config = CSSEngineConfig;
    type Requirements = CSSRequirements;
}
//# sourceMappingURL=css-engine.types.d.ts.map