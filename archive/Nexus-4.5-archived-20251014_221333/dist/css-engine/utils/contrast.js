 ...
 */
export function passesWCAG(ratio, level = 'AA', usage = 'normal-text') {
    if (level === 'AAA') {
        if (usage === 'large-text')
            return ratio >= 4.5;
        return ratio >= 7;
 ...
 */
export function auditRamp(ramp, level = 'AA') {
    const audits = [];
 ...
 */
export function optimalTextColor(backgroundColor, level = 'AA') {
 ...
 */
export function generateAccessiblePairs(baseColor, level = 'AA') {
