 ...
 */
export class TypographyArchitect {
    id = 'typography-architect';
    timeoutMs = 80;
    /**
    ...
    async run(dna, opts) {
        ...
        try {
            ...
            throw new Error(`TypographyArchitect failed: ${error.message}`);
        }
    }
    /**
     ...
     */
    getRatio(name) {
        return SCALE_RATIOS[name] ?? SCALE_RATIOS.perfectFourth;
    }
    /**
     ...
     */
    generateModularScale(base, ratio) {
        const steps = {};
     ...
     */
    generateFluidScale(steps, minVw = 320, maxVw = 1920) {
        const fluidSteps = {};
     ...
     * @returns Line height multiplier
     */
    calculateLineHeightForSize(size) {
     ...
     */
    generateResponsiveScale(steps, breakpoints) {
        const responsive = {};
 ...
 */
export function createTypographyArchitect() {
    return new TypographyArchitect();
}
//# sourceMappingURL=TypographyArchitect.js.map