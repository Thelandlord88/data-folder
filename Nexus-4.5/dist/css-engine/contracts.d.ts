 ...
 * Error types
 */
export declare class DesignEngineError extends Error {
    code: string;
    details?: unknown | undefined;
    constructor(message: string, code: string, details?: unknown | undefined);
}
export declare class SpecialistTimeoutError extends DesignEngineError {
    constructor(specialistId: string, timeoutMs: number);
}
export declare class ValidationError extends DesignEngineError {
