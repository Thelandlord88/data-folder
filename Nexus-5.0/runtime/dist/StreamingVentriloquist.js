...
export class StreamingVentriloquist {
     ...
     * ```
     */
    static async *streamDebate(config) {
     ...
     */
    static generatePersonalityResponse(personality, request, round, allPersonalities) {
        ...
        return (templates[personality]?.[round] || defaultTemplate[round]);
    }
    /**
     * Generate consensus from all personalities
     */
    static generateConsensus(personalities, request) {
     ...
     */
    static async *streamStandardResponse(request, personalities) {
        yield {
            type: 'header',
...
//# sourceMappingURL=StreamingVentriloquist.js.map